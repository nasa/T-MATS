...
MWS.HPT.PRVec = [ 3.000 3.250 3.500 3.750 4.000 4.250 4.500...
 ...
 MWS.HPT.WcArray = [ 30.446 30.533 30.568 30.572 30.572 30.572 30.572...
 ...
 MWS.HPT.EffArray = [0.8460 0.8405 0.8349 0.8296 0.8249 0.8206 0.8165...
...
%--------- scaler for corrected flow  ----------
 MWS.HPT.s_Wc = 0.444192;

%--------- scaler for pressure ratio ----------

MWS.HPT.s_PR = 0.511630;
%--------- scaler for efficiency ----------
   
MWS.HPT.s_eff = 0.998914;
%--------- scaler for corrected HPT speed ----------

MWS.HPT.s_Nc = 45.611020;