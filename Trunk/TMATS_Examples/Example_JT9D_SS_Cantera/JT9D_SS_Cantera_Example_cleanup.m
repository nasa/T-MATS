function JT9D_SS_Cantera_Example_cleanup(MWS)
%		T-MATS -- JT9D_SS_Cantera_Example_cleanup.m
% *************************************************************************
...
try
    ...
    Pth1 = strcat(top_level,pathOperator,'Maps');
    ...
    disp('Unable to remove T-MATS example JT9D Steady State Cantera directories from the path.')
end
