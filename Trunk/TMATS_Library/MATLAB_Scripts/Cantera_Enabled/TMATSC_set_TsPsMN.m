%       T-MATS -- TMATSC_set_TsPsMN.m
% *************************************************************************
% written by Thomas Lavell and Jeffryes Chapman
...
function [outFlow] = TMATSC_set_TsPsMN( Ts, Ps, MN, comp )
...
while  abs (lasterr)>.0000001 && count < 50 
     ...
     [Pt, PtLast, lasterr] = TMATSC_iterSecant( root, Pt, PtLast, lasterr, .1 );
end
