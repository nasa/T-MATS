...
#define WcMapCol_p(S)           ssGetSFcnParam(S,17)
#define EffMapCol_p(S)          ssGetSFcnParam(S,18)
#define WcMapRw_p(S)            ssGetSFcnParam(S,19)
#define EffMapRw_p(S)           ssGetSFcnParam(S,20)
#define ConfigNPSS_p(S)         ssGetSFcnParam(S,21)
#define NPARAMS 22
