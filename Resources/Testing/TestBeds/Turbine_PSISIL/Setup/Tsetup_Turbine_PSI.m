function [MWS] = Tsetup_Turbine_PSI(MWS)
...
% Dec 18th, 2012
%
% This function creates the properties of the Turbine_PSI component.
% *************************************************************************


MWS.TurbPSI.NcVec = [60 70 80 90 100 110];

MWS.TurbPSI.PRVec = [ 3.000 3.250 3.500 3.750 4.000 4.250 4.500...
    4.750 5.000 5.250 5.500 5.750 6.000 6.250...
    6.500 6.750 7.000 7.250 7.500 8.000 ];

MWS.TurbPSI.WoWArray = (10^-4)*[ 30.446 30.533 30.568 30.572 30.572 30.572 30.572...
...
MWS.TurbPSI.EffArray = [0.8460 0.8405 0.8349 0.8296 0.8249 0.8206 0.8165...
...
MWS.TurbPSI.s_Wc = 0.4504;

%--------- scaler for pressure ratio ----------

MWS.TurbPSI.s_PR = 0.9736;
%--------- scaler for efficiency ----------

MWS.TurbPSI.s_eff = 0.9984;
%--------- scaler for corrected Turb speed ----------

MWS.TurbPSI.s_Nc = 1.2/0.0243;
...
%--------- define PSI map ----------
MWS.TurbPSI.PSIArrayI = zeros(size(MWS.TurbPSI.EffArray));
for i = 1: length(MWS.TurbPSI.NcVec)
    MWS.TurbPSI.PSIArrayI(i,:) = MWS.TurbPSI.PRVec ./ MWS.TurbPSI.EffArray(i,:);
end
