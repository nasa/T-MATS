function MWS = TVec_Turbine_PSI(MWS)
%		TMATS -- setup_Turbine_PSI.m
% *************************************************************************
...
MWS.TV.VarNames = {'TurbPSI' 'W' 'FARc' 'Tt' 'Pt' 'PSI' 'Nmech' 'Wcool' 'Ttcool'...
                    'Ptcool' 'FARccool'};
                            ...
                            for i8 = 1:length(FARcIn_cool)
                                for i9 = 1:length(TtIn_cool)
                                    for i10 = 1:length(PtIn_cool)
                                        ...
                                        MWS.TV.TV(5,a) = PSI(i5);
                                        MWS.TV.TV(6,a) = Nmech(i6);
                                        MWS.TV.TV(7,a) = WIn_cool(i7);
                                        MWS.TV.TV(8,a) = TtIn_cool(i8);
                                        MWS.TV.TV(9,a) = PtIn_cool(i9);
                                        MWS.TV.TV(10,a) = FARcIn_cool(i10);
                                        a = a + 1;
                                    end
                                end
                            end
