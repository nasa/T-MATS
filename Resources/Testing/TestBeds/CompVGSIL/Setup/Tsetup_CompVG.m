function [MWS] = Tsetup_CompVG(MWS)
...
% *************************************************************************
 ...
 MWS.CompVG.NcVec = [0.500 0.600 0.700 0.750 0.800 0.850 0.900 0.925...
                   0.950 0.975 1.000 1.025 1.050];

 MWS.CompVG.RlineVec = [    1.000    1.200    1.400    1.600    1.800    2.000...
                       2.200    2.400    2.600    2.800    3.000 ];
 
 MWS.CompVG.AlphaVec = [ 1 2 3];


%========== Wc = f(NcMap, RlineMap) ==================
 MWS.CompVG.WcArray = [ 22.7411  24.0487  25.1548  26.0615  26.7738  27.2992...
 ...
 MWS.CompVG.WcArray(:,:,2) = MWS.CompVG.WcArray(:,:,1)+1;
 MWS.CompVG.WcArray(:,:,3) = MWS.CompVG.WcArray(:,:,1)+2;
%========== eff = f(NcMap, RlineMap) ==================
 MWS.CompVG.EffArray = [0.6753 0.6913 0.7016 0.7050 0.7004 0.6864 0.6570...
...
MWS.CompVG.EffArray(:,:,2) = MWS.CompVG.EffArray(:,:,1)+0.01;
MWS.CompVG.EffArray(:,:,3) = MWS.CompVG.EffArray(:,:,1)+0.02;
%========== PR = f(NcMap, RlineMap) ==================
MWS.CompVG.PRArray = [ 2.4769  2.4288  2.3620  2.2778  2.1774  2.0627... 
...
MWS.CompVG.PRArray(:,:,2) = MWS.CompVG.PRArray(:,:,1)+0.5;
MWS.CompVG.PRArray(:,:,3) = MWS.CompVG.PRArray(:,:,1)+1.0;
%------ scaler for corrected flow -------------
MWS.CompVG.s_Wc = 0.98;

%--------- scaler for pressure ratio ----------
MWS.CompVG.s_PR = 0.99; 

%--------- scaler for efficiency ----------  
MWS.CompVG.s_eff = 0.9977;

%--------- scaler for corrected Compressor speed ----------
 MWS.CompVG.s_Nc =  10000/2;

 %--------- Define customer bleed ----------
 MWS.CompVG.CBD = 3;
 MWS.CompVG.CBFht = 0.5;
 MWS.CompVG.CBFPt = 0.5;
 
 %--------- Define fractional bleed ----------
 MWS.CompVG.FBD = 0.05;
 MWS.CompVG.FBht = 0.5;
 MWS.CompVG.FBPt = 0.5;
 
%--------- Define Stall Margin ----------
 MWS.CompVG.WcSurgeVec = [  0   0   0;
                          100 100 100];
 MWS.CompVG.PRSugeVec = [30 30 30;
                         31 32 33];
