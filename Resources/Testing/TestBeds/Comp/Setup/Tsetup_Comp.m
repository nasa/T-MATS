...
% *************************************************************************
 ...
 MWS.Comp.NcVec = [0.500 0.600 0.700 0.750 0.800 0.850 0.900 0.925...
                   0.950 0.975 1.000 1.025 1.050];

 MWS.Comp.RlineVec = [    1.000    1.200    1.400    1.600    1.800    2.000...
                       2.200    2.400    2.600    2.800    3.000 ];


%========== Wc = f(NcMap, RlineMap) ==================
 MWS.Comp.WcArray = [ 22.7411  24.0487  25.1548  26.0615  26.7738  27.2992...
...
%========== eff = f(NcMap, RlineMap) ==================
 MWS.Comp.EffArray = [0.6753 0.6913 0.7016 0.7050 0.7004 0.6864 0.6570...
...
%========== PR = f(NcMap, RlineMap) ==================
 MWS.Comp.PRArray = [ 2.4769  2.4288  2.3620  2.2778  2.1774  2.0627... 
...
MWS.Comp.s_Wc = 0.4953;

%--------- scaler for pressure ratio ----------
MWS.Comp.s_PR = 0.8636; 

%--------- scaler for efficiency ----------  
MWS.Comp.s_eff = 0.9977;

%--------- scaler for corrected Compressor speed ----------
 MWS.Comp.s_Nc =  1 / 0.0001;
...
%--------- Define Stall Margin ----------
 MWS.Comp.WcSurgeVec = [0  200];
 MWS.Comp.PRSugeVec = [30 30];
