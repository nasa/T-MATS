function GasTurbine_SS_Example_cleanup(MWS)
%		T-MATS -- GasTurbine_SS_Example_cleanup.m
% *************************************************************************
...
try
    ...
    disp('Unable to remove T-MATS example Steady State Gas Turbine directories from the path.')
end
